...
<h1 align="center"><font color="#FFFFFF">Comentarios</font></h1>
<table align="center"><form method="post" action="insertComentario.php">
<tr><td><font color="#CCCCCC">Nombre: </font></td><td><input type="text" style="width:600px;height:20px;border-radius:4px;" maxlength="35" placeholder="Ingrese su Nombre" name="usuario"/></td>
<tr><td><font color="#CCCCCC">Correo Electronico:</font></td><td><input style="width:600px;height:20px;border-radius:4px;" type="text" maxlength="25" placeholder="Ingrese su Correo" name="correo"/></tr></td>
<tr><td> <font color="#CCCCCC">Comentario:</td><td> <textarea style="width:600px;height:150px;border-radius:4px;" type="text" name="comentario" placeholder="Comentario"></textarea>
</font></td></tr>
<tr><td colspan="2" align="center"><button type="submit">Enviar</button></tr></td>
</form>
